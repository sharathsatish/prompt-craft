...
- **Share new prompt techniques** or engineering approaches
- **Add workflow templates** for specific development scenarios
- **Contribute case studies** from real-world implementations
...
- Be cross-LLM compatible when possible
...
```text
foundations/     - Core prompt engineering principles
workflows/       - SDLC-specific templates and processes
resources/       - Case studies, learnings, and insights
quick-reference/ - Templates and quick solutions
...
- [ ] Tested with ChatGPT
- [ ] Tested with Claude
- [ ] Tested with other LLMs (specify which)
...
1. Test prompts with at least 2 different LLMs
2. Verify all links work correctly
3. Check formatting in preview mode
4. Ensure examples are reproducible
...
Thank you for helping make Prompt Craft a valuable resource for everyone! 🚀

---

*Remember: Great contributions aren't just about quantity—focus on quality, practical value, and clear communication.*